  ...
  soap.createClient(url, function(err, client) {
    client.Counts(args, function(err, xml) {
      parseString(xml.CountsResult, function(err, result) {
        ...
        console.log(result.Mold.Machine[0].$.id);
        console.log(result.Mold.Machine[0].Sensor[0].Rejects[0]);
        console.log(result.Mold.Machine[0].Sensor[1].Rejects[0]);
        console.log(result.Mold.Machine[0].Sensor[2].Rejects[0]);
